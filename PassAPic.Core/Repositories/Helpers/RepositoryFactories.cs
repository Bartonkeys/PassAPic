...
namespace PassAPic.Repositories.Helpers
{
    /// <summary>
    /// A maker of TheAppBuilder Repositories.
    /// </summary>
    /// <remarks>
    ...
    public class RepositoryFactories
    {
        ...
        /// <summary>
        /// Return the runtime PassAPic repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM PassAPic FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetPassAPicFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(IUserRepository), dbContext => new EFUserRepository(dbContext)}
                };
        }

        /// <summary>
        /// Constructor that initializes with runtime TheAppBuilder repository factories
        /// </summary>
        public RepositoryFactories()
        {
            _repositoryFactories = GetPassAPicFactories();
        }
        ...
        /// <summary>
        /// Default factory for a <see cref="IRepository{TEntity}"/> where T is an entity.
        /// </summary>
